...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (contactForm) {
    ...
    const validateField = (input) => {
      const name = input.name || input.getAttribute('data-validate') || input.type;
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '2840725c-19f2-437d-a54f-e2489c748ba4',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '2840725c-19f2-437d-a54f-e2489c748ba4';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '2840725c-19f2-437d-a54f-e2489c748ba4';
